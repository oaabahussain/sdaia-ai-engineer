> **Current governance note — 2026-09-26:** Programme A has been merged to `main`, deployed, and post-merge verified. This constitution remains the architectural baseline; the 2026-09-26 research amendment adds evidence-backed rules for later programmes without rewriting the historical decisions below.\n\n# Learning Platform vNext — Architecture and Repository Constitution
